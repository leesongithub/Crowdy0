                    ...
                    geojson.features.forEach(function(marker) {
                        ...
                        new mapboxgl.Marker(el, { offset: [0, -23] })
                            ...
                            .setPopup(new mapboxgl.Popup({ offset: 25 }) // add popups
                                .setHTML('<h3 style="font-family: phosphate;">' + marker.properties.name + '</h3><p style="text-align: center; font-size: 16px;"> Crowdedness: ' + marker.properties.rating + '%</p> <form action="listings.theater({ theaterName: ' + marker.properties.name + '})"><input type="submit"/></form>'))
                            .addTo(map);
                    });
